...
@register_model('synsem_transformer')
...
@register_model_architecture('synsem_transformer_sent', 'synsem_transformer_sent')
...
@register_model_architecture('synsem_transformer_sent', 'synsem_transformer_iwslt_de_en_sent')
...
@register_model_architecture('synsem_transformer_sent', 'synsem_transformer_iwslt_de_en_sent_small')
def multilingual_transformer_iwslt_de_en(args):
